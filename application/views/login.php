...
<html lang="en">
    <head>
        ...
        <title>Sistem Pengambilan Keputusan Metode MAUT</title>
		...
		<link rel="shortcut icon" href="<?= base_url('assets/')?>img/kemdikbud.png" type="image/x-icon">
		<link rel="icon" href="<?= base_url('assets/')?>img/kemdikbud.png" type="image/x-icon">
    </head>

    <body class="bg-gradient-success">
        <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
            <div class="container">
                <a class="navbar-brand text-success" style="font-weight: 900;" href="<?= base_url('')?>"> <i class="fa fa-database mr-2 rotate-n-15"></i> Sistem Pengambilan Keputusan Metode MAUT</a>
            </div>
        </nav>
                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-7">Login Account</h1>
                                            <img src="assets/img/unimal.png" alt="" width="40%" style="margin-bottom: 10px;">
                                        </div>
				...
				<div class="col-xl-6 col-lg-6 col-md-6 mt-5">
                    <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                        <div class="text-justify card-body p-0">
                            <h4 style="font-weight: 800;">Sistem Pengambilan Keputusan Metode MAUT</h4>
                            <p class="pt-4">
                                Sistem Pengambilan Keputusan (SPK) merupakan suatu sistem informasi spesifik yang ditujukan untuk membantu manajemen dalam mengambil keputusan yang berkaitan dengan persoalan yang bersifat semi terstruktur.
                            </p>
                            <p>
